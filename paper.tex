...
\begin{table}[t]
\centering
\caption{Smoothing control at $N{=}207$: MAE under temporal Gaussian smoothing ($\sigma$), 3 seeds. Persistence at $\sigma{=}0$ (3.38) differs from Table~\ref{tab:model_comparison} (3.51) due to denormalization timing differences (smoothing applied before normalization).}
\label{tab:smoothing}
\begin{tabular}{lccccc}
\toprule
Model & $\sigma{=}0$ & $\sigma{=}1$ & $\sigma{=}2$ & $\sigma{=}3$ & Pers.\ ($\sigma{=}0$) \\
\midrule
DCRNN        & 3.68$\pm$0.12 & 1.49$\pm$0.02 & 0.58$\pm$0.02 & 0.39$\pm$0.02 & 3.38 \\
GraphWaveNet & 3.61$\pm$0.08 & 2.19$\pm$0.16 & 1.35$\pm$0.03 & 1.01$\pm$0.04 & 3.38 \\
LSTGCNN      & 5.08$\pm$0.02 & 3.59$\pm$0.01 & 2.97$\pm$0.00 & 2.89$\pm$0.04 & 3.38 \\
\bottomrule
\end{tabular}
\end{table}
...
Dropout (default) & 0.1 \\
Seeds & $\{42, 123, 456, 789, 1024\}$ $\times$ 2\textsuperscript{sets} = 10 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[t]
\centering
\caption{Per-model architecture details and parameter counts (at $N = 207$)}
\label{tab:model_params}
\begin{tabular}{llcc}
\toprule
Model & Spatial layer & Temporal layer & Params \\
\midrule
LSTGCNN      & Spectral GCN $\times$2     & LSTM $\times$2        & 172K \\
DCRNN        & Diffusion Conv (K=2) & DCGRU $\times$2       & 172K \\
STGCN        & ChebConv (K=3) $\times$2   & Gated 1D conv $\times$2 & 234K \\
GraphWaveNet  & Self-adaptive adj   & Dilated causal conv $\times$6 & 160K \\
GAT          & Multi-head attn $\times$2 (4 heads) & LSTM $\times$2  & 190K \\
RandomGAT    & Fixed degree-norm   & LSTM $\times$2        & 170K \\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
Dataset & Model & $a$ & $b$ & $R^2$ & 95\% CI \\
\midrule
METR-LA   & DCRNN        & 1.572 & 0.173 & 0.987 & [0.160, 0.189] \\
METR-LA   & LSTGCNN      & 2.533 & 0.176 & 0.719 & [0.098, 0.293] \\
METR-LA   & GraphWaveNet & 1.624 & 0.157 & 0.984 & [0.142, 0.176] \\
PeMS-Bay  & DCRNN        & 0.839 & 0.291 & 0.862 & [0.215, 0.368] \\
PeMS-Bay  & STGCN        & 0.795 & 0.325 & 0.793 & [0.302, 0.605] \\
PeMS-Bay  & LSTGCNN      & 0.821 & 0.284 & 0.860 & [0.210, 0.358] \\
\bottomrule
\end{tabular}
\end{table}
